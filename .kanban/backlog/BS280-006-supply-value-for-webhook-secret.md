...
an SSM Parameter Store placeholder at `/productsweet/projects/ai6p-280-sacrificial/webhook-secret` (tagged
...
- `aws ssm put-parameter --name /productsweet/projects/ai6p-280-sacrificial/webhook-secret --type SecureString --overwrite --value '<real-value>'`
...
- SSM path: `/productsweet/projects/ai6p-280-sacrificial/webhook-secret`
...
2. `aws ssm put-parameter --overwrite --name /productsweet/projects/ai6p-280-sacrificial/webhook-secret --type SecureString --value '<real>'`
...
- `aws ssm get-parameter --name /productsweet/projects/ai6p-280-sacrificial/webhook-secret --with-decryption` returns the real value (do
...
- The `productsweet:secret-state=placeholder` tag is no longer present:
  `aws ssm list-tags-for-resource --resource-type Parameter --resource-id /productsweet/projects/ai6p-280-sacrificial/webhook-secret`.
